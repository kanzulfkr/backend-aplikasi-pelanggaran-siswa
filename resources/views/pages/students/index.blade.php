                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button class="btn btn-danger btn-action" onclick="deleteConfirmation('{{  route('students.destroy', $student->id) }}')">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                                <form id="form-delete" action="{{ route('students.destroy', $student->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
