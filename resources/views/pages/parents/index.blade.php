    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">All Wali Murid</div>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table-striped table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ $parent->gender == 'perempuan' ? 'Perempuan' : 'Laki-Laki' }}
                                        </td>
                                        <td>
                                            {{ $parent->phone }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button class="btn btn-danger btn-action" onclick="deleteConfirmation('{{  route('parents.destroy', $parent->id) }}')">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                                <form id="form-delete" action="{{ route('parents.destroy', $parent->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
