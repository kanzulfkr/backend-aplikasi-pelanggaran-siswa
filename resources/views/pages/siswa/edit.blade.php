...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <div class="card">
                <form action="{{ route('siswa.update', $user) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                ...
                                <label class="selectgroup-item">
                                    <input type="radio" name="roles" value="dosen" class="selectgroup-input" @if ($user->roles == 'dosen') checked @endif>
                                    <span class="selectgroup-button">Dosen</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="roles" value="mahasiswa" class="selectgroup-input" @if ($user->roles == 'mahasiswa') checked @endif>
