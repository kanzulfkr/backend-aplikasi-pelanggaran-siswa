...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Dashboard Pihak Tata Tertib</h1>
        </div>
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                <div class="card card-hero">
                    <div class="card-header">
                        ...
                        <h4>{{ $totalsData['violationUnValidate'] }}</h4>
                        <div class="card-description">Pelanggaran membutuhkan validasi dari anda!</div>
                    </div>
                    <div class="card-body p-0">
                        <div class="tickets-list">
                            <div class="card-body">
                                @forelse ($unValidateViolations as $unValidateViolation)
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <div class="text-primary text-small ml-3 float-right">
                                                {{ $unValidateViolation->created_at->locale('id')->diffForHumans(); }}
                                            </div>
                                            <div class="media-title">
                                                {{ $unValidateViolation->student->user->name }}
                                                <span class="text-muted" style="font-weight: normal;"> mendapatkan pelanggaran baru.</span>
                                            </div>
                                            <div class="text-small">
                                                ditambahkan oleh <span class="text-muted" style="font-weight: 600;"> {{ $unValidateViolation->officer->user->name }}</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
